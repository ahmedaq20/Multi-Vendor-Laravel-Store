<x-front-layouts :title="$product->name">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-info">
                            ...
                            <h3 class="price">{{Currency::format($product->price,'USD')}}<span>@if ($product->compare_price)
                                {{Currency::format($product->compare_price,'USD')}}
                            @endif</span></h3>
